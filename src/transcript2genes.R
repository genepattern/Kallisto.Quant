...
write.csv(so$obs_norm[, c(2,4)], paste0('RNASeq_quant/',args[2],'.csv'), quote=FALSE, row.names=FALSE)
write.csv(so$obs_norm, paste0('RNASeq_quant/',args[2],'_full_gene_level.csv'), quote=FALSE, row.names=FALSE)
write.csv(so$obs_raw, paste0('RNASeq_quant/',args[2],'_transcript_level.csv'), quote=FALSE, row.names=FALSE)
write.csv(counts, paste0('RNASeq_quant/',args[2],'_raw_estimated_counts.csv'), quote=FALSE, row.names=FALSE)
